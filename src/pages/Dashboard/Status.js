...
const actions = (
  <Fragment>
    <Button type="primary" onClick={backTop}>
      <FormattedMessage id="app.result.status.btn-return" defaultMessage="Back" />
    </Button>
    <Button>
      <FormattedMessage id="app.result.status.btn-project" defaultMessage="View" />
    </Button>
    {/* <Button>
...
export default () => (
  <PageHeaderWrapper>
    <Card bordered={false}>
      <Result
        type="success"
        title={formatMessage({ id: 'app.result.status.title' })}
        description={formatMessage({ id: 'app.result.status.description' })}
        extra={extra}
        actions={actions}
