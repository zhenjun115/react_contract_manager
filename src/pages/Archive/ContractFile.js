...
class ContractFile extends PureComponent {
  render() {
    const desc1 = (
      <div
        style={{
      ...
      <Fragment>
        ...
        <Row style={{ marginBottom: 16 }}>
          <Col xs={24} sm={12} md={12} lg={12} xl={6}>
            <span style={{ color: 'rgba(0, 0, 0, 0.85)' }}>合同编号:&nbsp;&nbsp;</span>
            23421
          </Col>
          <Col xs={24} sm={12} md={12} lg={12} xl={6}>
        ...
        <Steps style={{ marginLeft: -42, width: 'calc(100% + 84px)' }} progressDot current={1}>
          <Steps.Step title={<span style={{ fontSize: 14 }}>创建合同</span>} description={desc1} />
        ...
        <Row gutter={24}>
          <Col span={6}>
            <Card>
              ...
              >
                <Tree.TreeNode title="劳务合同" key="0-0">
                  <Tree.TreeNode title="合同一" key="0-0-0" isLeaf />
                  <Tree.TreeNode title="合同二" key="0-0-1" isLeaf />
                </Tree.TreeNode>

                <Tree.TreeNode title="采购合同" key="0-1">
                  <Tree.TreeNode title="合同一" key="0-1-0" isLeaf />
                  <Tree.TreeNode title="合同二" key="0-1-1" isLeaf />
                </Tree.TreeNode>
              </Tree.DirectoryTree>
            </Card>
          </Col>
