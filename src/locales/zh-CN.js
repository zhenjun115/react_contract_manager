export default {
  ...
  'menu.dashboard.workplace': '工作',
  'menu.dashboard.contract': '合同',
  'menu.dashboard.contract.status': '审批状态',
  'menu.form': '表单页',
  ...
  'menu.template.contract': '合同模版',
  'menu.template.purchase_contract': '采购模版',
  'menu.template.purchase_contract.create': '新建',
  'menu.purchase': '采购合同',
  'menu.purchase.contract': '合同',
  'menu.purchase.template': '模版',
  'menu.labor': '劳务合同',
  'menu.labor.contract': '合同',
  'menu.labor.template': '模版',
  'menu.system': '系统管理',
  'menu.system.dict': '数据字典',
  'menu.archive': '归档管理',
  'menu.archive.contract': '合同归档',
  'menu.archive.template': '模版归档',
  ...
  'app.result.status.description':
    '此页面表示操作流程缩略图,应当可以切换到其他页面查看详细审批流程',
  ...
  'app.result.success.step1-operator': '创建人',
  'app.workflow.start.user': '创建人',
  'app.workflow.start.contract': '创建合同',
  'app.workflow.start.contract.review': '法务复核',
  'app.workflow.contract.partyMain': '甲方签字',
  'app.workflow.contract.partyOther': '乙方签字',
  ...
  'app.result.status.btn-return': '返回列表',
  'app.result.success.btn-project': '查看项目',
  'app.result.status.btn-project': '查看合同',
